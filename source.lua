...
function YOXILibrary.new(destroyOnUnload, title, description, keybind, logo)
        ...
        for _, name in pairs(tabNames) do
            ...
            function Tab:NewSection(title, icon, position)
                ...
                function Section:NewColorPicker(title, default, callback)
                    ...
                    Picker.BackgroundColor3 = CurrentTheme.Gray
                ...
                function Section:NewSlider(title, min, max, default, callback)
                    ...
                    Slider.BackgroundColor3 = CurrentTheme.Gray
                    ...
                    SliderBar.BackgroundColor3 = CurrentTheme.LightGray
                ...
                function Section:NewDropdown(title, options, default, callback)
                    ...
                    Dropdown.BackgroundColor3 = CurrentTheme.Gray
                    ...
                    Label.BackgroundColor3 = CurrentTheme.Gray
                    Label.TextColor3 = CurrentTheme.Text
                    ...
                    DropdownList.BackgroundColor3 = CurrentTheme.DarkGray
                ...
                function Section:NewKeybind(title, default, callback)
                    ...
                    Keybind.BackgroundColor3 = CurrentTheme.Gray
                ...
                function Section:NewProgressBar(title, min, max, default, callback)
                    ...
                    Progress.BackgroundColor3 = CurrentTheme.Gray
                    ...
                    Bar.BackgroundColor3 = CurrentTheme.LightGray
                    Bar.Parent = Progress
                ...
                function Section:NewConfigButton(saveCallback, loadCallback)
                    ...
                    ConfigButton.BackgroundColor3 = CurrentTheme.LightGray
                    ...
                    LoadButton.BackgroundColor3 = CurrentTheme.LightGray
    ...
    local function AnimateWindow(show)
        ...
        if show then
            ...
            local tween = TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Size = UDim2.new(0, 0, 0, 40)})
            tween:Play()
            tween.Completed:Wait()
            MainFrame.Visible = false
        end
...
function YOXILibrary.Notification(title, desc, duration, icon)
    ...
    local tweenIn = TweenService:Create(Notif, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Position = UDim2.new(0, 10, 0, 10)})
    tweenIn:Play()
    game:GetService("Debris"):AddItem(Notif, duration or 3)
    tweenIn.Completed:Wait()
    local tweenOut = TweenService:Create(Notif, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Position = UDim2.new(0, 10, 0, -100)})
...
function YOXILibrary.LoadTheme(themeName)
    ...
    if success then
        ...
        CurrentTheme = {
            ...
            DarkGray = Color3.fromRGB(theme.DarkGray[1], theme.DarkGray[2], theme.DarkGray[3]),
            Gray = Color3.fromRGB(theme.Gray[1], theme.Gray[2], theme.Gray[3]),
            LightGray = Color3.fromRGB(theme.LightGray[1], theme.LightGray[2], theme.LightGray[3]),
